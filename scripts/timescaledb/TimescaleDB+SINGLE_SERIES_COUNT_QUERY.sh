...
do
	...
	do
		...
		sleep 60s
                ...
                java -jar /data/dbms/BenchTSDB/BenchTSDB-1.0-jar-with-dependencies.jar -r "/data/dbms/BenchTSDB/configs/timescaledb/TimescaleDB+SINGLE_SERIES_COUNT_QUERY_$i.properties" #note this should NOT be made background !!!!!!
        done
done
